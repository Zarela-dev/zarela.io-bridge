    ...
    if (typeof localStorage !== 'undefined') {
      try {
        ...
        if (localStorage.getItem('feature_test') === 'yes') {
          ...
          console.log('this browser does not support localstorage, some features may not work properly!', 'error')
